package com.example.baiktth_bai4;
...
public class UpdateActivity extends AppCompatActivity {
    final String DATABASE_NAME = "ManagerSinhVien.sqlite";
    ...
    private void update(){
        ...
        SQLiteDatabase database = Database.initDatabase(this, "ManagerSinhVien.sqlite");
